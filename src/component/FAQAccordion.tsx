...
const faqItems = [
  ...
  },
  {
    ...
    content: 'نعم، يشترط حضور ما لا يقل عن نصف عدد الأعضاء في الأيام الحضورية المحددة، ويُعد ذلك شرطًا أساسيًا للتأهل للفوز.',
  },
  {
    id: 'faq4',
    title: 'ماذا أفعل إن لم يكن لدي فريق؟',
    content: <span>يمكنك البحث عن فريق من خلال مجتمع دال في التيليجرام. <b><a href="https://t.me/+Bq7GmSlDY_liNGI8" target="_blank" rel="noopener noreferrer">اضغط هنا</a></b></span>,
  },
  {
    id: 'faq5',
  ...
  },
  {
    ...
    content: 'لا، يتم اختيار الفريق في التسجيل المبدئي بناءً على مؤهلات أعضاءه من الناحية التقنية والصحية.',
  },
  {
    id: 'faq7',
