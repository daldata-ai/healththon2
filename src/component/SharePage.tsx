...
export default function SharePage() {
  ...
  <div className="min-h-screen bg-dark-green flex items-center justify-center p-6 border-t-4 border-b-4 border-light-green">
      <div className="text-center max-w-md w-full">
        {/* Header */}
        <div className="mb-8">
          <div className="w-16 h-16 bg-light-green rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
        ...
        <div className="space-y-3">
          ...
          {copied && (
            <div className="text-center">
              <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-light-green text-white border border-light-green">
